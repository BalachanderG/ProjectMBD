...
public class StoreBillReportTest {
	
	public static int FBID = 11011101;
	...
	public static void main(String args[]){
		...
		//generate a bill
		Bills testBill = BillGenerator.generateABill(10, 1000, 5);
		
		// Request the server to store the bill
		StoreBillsRequest reportBills = new StoreBillsRequest(FBID, FBAUTH, C2DMAUTH, testBill);
...
//		Response testResponse = shexpClient.sendRequest(new PingRequest(10));
		if(ErrorResponse.class.isInstance(billreported)){
